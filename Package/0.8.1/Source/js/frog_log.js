...
var frog_log = {
    ...
    'on | button, a, span | click': function(ev, el) {
        ev.preventDefault();
        ...
        this[ action ]( $this, ev, user, pass );
        this.save( self.form );
        this.updateButtons();
    },
    
    'on | input | keyup': function(ev, el) {
        ev.preventDefault();
        
        if ( $(this).hasClass('url') ) {
            this.updateActiveSiteUrl( $(this).val() );
        }
        this.save( this.form );
        this.updateButtons();
    ...
    'on | .sites li | click': function(ev, el) {        
        ev.preventDefault();
